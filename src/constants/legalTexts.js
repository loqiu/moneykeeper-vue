export const userAgreementText = `欢迎使用 MoneyKeeper（以下简称“本应用”）。为了保障您的合法权益，请在使用本应用前仔细阅读并充分理解以下条款。

一、服务内容
记账功能：本应用为用户提供记账与统计功能，便于用户跟踪日常开支或收入情况。
...
export const privacyPolicyText = `我们非常重视您的隐私，以下为我们在收集、使用和保护用户信息方面的原则与措施。
